...
```
<!-- Exclude the specific PLS figure generation from supplementary but keep teh general build up of the figure -->
...
plot_evpi_STEM <- plot_evpi(EVPIresults = evpi, 
                            ...
                            input_table = input_table)+ scale_x_continuous(limits = c(0, 210)) 
